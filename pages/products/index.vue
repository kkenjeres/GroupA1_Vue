...
export default {
  ...
  async fetch  ({ store }) {
    await store.dispatch('productFilter/loadProductsTags', { tagsPoint: 'products/' })
  },
  async asyncData ({ store, query }) {
    await store.dispatch('productFilter/loadAllProducts', { startWith: 'products/', withTag: query.manufactur, perOnePage: query.per, pageNumber: query.page })
  },
  data () {
    return {
      select: '',
